...
public class Solitaire : MonoBehaviour
{
    ...
    public List<string> tripsOnDisplay = new List<string>();        //card random fack up
    ...
    public List<string> discardPile = new List<string>();    //card random facedown
    ...
    public void SortDeckIntoTrips()     //when want to show random card 3 a time change 1 into 3
    {
        ...
        if (tripsRemainder != 0)
        {
            ...
            {
                myRemainder.Add(deck[deck.Count - tripsRemainder + modifier]);
                modifier++;
            }
